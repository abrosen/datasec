///fieldset
jQuery.fn.Fieldset = function () {
	$(this).each(function (index, target) {
		$('.fieldset-header', $(target)).click(function () {

			if ($(this).hasClass("collapsed")) {
				$('.fieldset-body,', $(target)).removeClass("collapsed").addClass("expanded");
				$(this).removeClass("collapsed").addClass("expanded");
				
			}
			else {
				$('.fieldset-body ', $(target)).removeClass("expanded").addClass("collapsed");
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFNQpl8hiSZ8x
// SIG // ZyY4wtmLVR/Y/qLloIIT+DCCA+4wggNXoAMCAQICEH6T
...
// SIG // FgQUyxbq2cyNxGuabmXbaN65aDr7b34wDQYJKoZIhvcN
// SIG // AQEBBQAEggEAR7MTAmO/EyExhp7ioFr9pphsaCQlemWf
// SIG // PV8fpi+jww89x1Ttcg5Z9iuFMYIn4KZc2mFmnKDl9gZh
// SIG // Np/UjcqxX+0dTGkFpa7f1gnFE8yOnGocM1kAHO6ToR7k
// SIG // P5Hnc/hPJRR3IerNXSrMjxnO3D5QPR8TT1rMZ87S0TdR
// SIG // H2Mz91uGhZzMjvgFrcmF3bISN52kRBcTnrl7pQLO2UF5
// SIG // rQ391VE/fUuu0jfLlMm3jm2b9zW+AZL7CPa2ITXKHc/z
// SIG // X2cotu/MNGdCYNxE1cw7VeK1SuW18QIUv0oyPquBpqBb
// SIG // pJnwLzJ4U2Mj+lXPz/spnvGA9eGT/V244F7G9muUmiMe
// SIG // 2KGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIBATBy
...
// SIG // BTEPFw0xNDA2MDUwNDM4MjJaMCMGCSqGSIb3DQEJBDEW
// SIG // BBRbS+WHWuIFNCu5LXUbpn590+OdHDANBgkqhkiG9w0B
// SIG // AQEFAASCAQBAykQTnXGi5ABBP3FSsDrm7z8OvWxx/IdD
// SIG // rOHsT7iCi2/uzRlfM+C6jCjgkL3LPJwSJtgLtAp/0Ixq
// SIG // caW3rZ8A/tlczw4fsmYT17eVje0t/X150yyAu2MnnFj5
// SIG // hLNBabPvlR98mIJ3Z/Sbqwvqlp4Im2Euo4lRmdUjpkZE
// SIG // 3D/MZNFECyYNyrYu7gIo4CRUTrg/FoWZp1CDwouil7me
// SIG // m+LHbqYvu2geMsiMXVS2/JrZ5ushc4Bboh8KcRZBa6fB
// SIG // sDmxHMJxS/oUm8F2zkXHzdHP40ulhEyzXrycIV4hpSHF
// SIG // LA+nu3KuBTEkbmdJt3n59qFhTcvjpl3VvnruxT7pTygH
