(function ($) {
	window.ModelState = {
		addError: function (exception, $content) {
			var errors = Notification.createErrors(exception);
			errors.show($content);
		},
		addErrorMessage: function (errorMessage, $content) {
			var error = new Notification.Error(errorMessage);
			Notification.errors.push(error);
			error.show($content);
		},
		clearErrors: function () {
			Notification.clearErrors();
		},
		process: function (modelState, $content) {
			try {
				var errors = Notification.createErrors(modelState);
				errors.show($content);
				return true;
			} catch (e) {
				return false;
	...
	$.ajaxSetup({
		error: function (jqXHR, textStatus, errorThrown) {
			...
			if (ContentDialog.instanceExists()) {
				$content = ContentDialog.getLatestInstance().$content;
			}
			
			ModelState.process(jqXHR, $content);
		},
		cache: false
	});
})(jQuery);
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFE3mgdroYOBx
// SIG // 1qsqvKmoYQ+7iwPkoIIT+DCCA+4wggNXoAMCAQICEH6T
...
// SIG // FgQUxDwuAg2/7v5PAw2HUlInR4aKn3wwDQYJKoZIhvcN
// SIG // AQEBBQAEggEAGEUY0t3vhCQHs4aGzhg7BaShDquZc+Wg
// SIG // yMY3MbiYwx8WTmulgHia4baZouUZfmEEox0doXae3jfh
// SIG // HyQ+UDMNCBRhJXRkuRJQpeC6q37dZydNbJp4Rtd/WI4D
// SIG // PMtxnRWEXTPMXCMNZl3Tvb4tRq22ls5A9l9y0YWLPHpq
// SIG // fPeDjqB84eSYlUxwpDWsbten7B+oGQ0+tN1e7uowGdYI
// SIG // eR7VOfxwR/3cdnAFgAeIYZ+1cNMKi67VxR5lLcq/DmGv
// SIG // hXcFs7tqwdwtU1QKbn0/X/stvMNjPDtMsaBMR44sEDNc
// SIG // tkTbXrjXwOOhlhTepROMCAbyeamRd60gs3Ty2yei7Jw2
// SIG // qqGCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIBATBy
...
// SIG // BTEPFw0xNDA2MDUwNDM4MTdaMCMGCSqGSIb3DQEJBDEW
// SIG // BBTY5wOb8QOFNYMVnU6dTlv+vCA20TANBgkqhkiG9w0B
// SIG // AQEFAASCAQBnV99Z9lr/QPoxdRSzwG0y3RxHmGeGGy8F
// SIG // d5MyrzDsQdIft2bLQkvlhj1IjXOS7TFeC6OhZSI7RyEX
// SIG // A4Ks/lagVQWk+N4ghpqOUGHgJpZQOqcmHaHCtBp738CO
// SIG // 5nk0mesCHO1W77iWJiXRxNiGdM5JrJr/2nlkDVlhQ7Of
// SIG // pyvFiUUZU6gSeWsV3aQVgOJK2SdQgyby+uX7eYDCg4KF
// SIG // C8vl5XhuaSoQ4pXXnOHpTce87z+GVQ0I4Se5UNav2dih
// SIG // EWJdPzuoaGyymvemBNO+OJzUcmR4hPx/M3/Hi/4DSQly
// SIG // bMgEQ47+bi+6t7NAKRBBTXINCtiI8zvVmul2M7ZJ4gn8
