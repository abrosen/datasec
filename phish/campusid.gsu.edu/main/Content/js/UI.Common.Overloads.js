/*
*	This file contains overloads of standart libraries' functions
*/

(function ($) {
	/* jQuery.validate link with jQuery.watermark
	*
	* In case of using unobtrusive validation validate submit handler attaches to form before watermark submit handler
	* so validation mechanism recognize watermarks as actual form and $.fn.valid return true instead of false
	* 
	* We need to hide all watermarks before validating the form
	*/
	if ($.watermark && $.watermark.hideAll) {
		if ($.validator && $.validator.prototype.form) {
			
			var oldForm = $.validator.prototype.form;
			$.validator.prototype.form = function () {
				$.watermark.hideAll();
				var valid = oldForm.apply(this, Array.prototype.slice.call(arguments));
				return valid;
			};
		}
	}
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFFyRTOnMnrDQ
// SIG // YYztFqYV3R+7F07QoIIT+DCCA+4wggNXoAMCAQICEH6T
...
// SIG // FgQUhZsNsurYifFOsWXyf/wyoRnOOo0wDQYJKoZIhvcN
// SIG // AQEBBQAEggEALy0uFNttvRGE7OH48Jxbf8ygNnyctX+3
// SIG // EaEcU9C1g5yrZXx7V/EY/XTvxA7VgawG3I3tWLCbjnw2
// SIG // x6UK7X2p8juFJoqj1F09TvcWMMGKIsPTj9M2svD3N8YK
// SIG // JHP4WmlowanXIvBFnmE8WoVTouw5vuP7g8HsLbLkrDAd
// SIG // VvhuHtbbhZ5kTEHOwJLmO2fkFuPixIdGVfI9MvFCkdV/
// SIG // 1V6yjL40+y7pME8bw1LzKZtp4N/m6BmiH2Nhw67VaXQj
// SIG // Jx6o9sxlf/FryRml84imK+RLk3nOgUP2aE3EJmi6AM7x
// SIG // sytqFTPEcpMqXV9/rsu5p3QyvQMo6FcCdxssi8b1ZHjl
...
// SIG // BTEPFw0xNDA2MDUwNDM4NDJaMCMGCSqGSIb3DQEJBDEW
// SIG // BBTr38eH8jN7LBvc8mYFZ/5WCbPjaTANBgkqhkiG9w0B
// SIG // AQEFAASCAQA5Y9HAhmQ7mSNn/6zJ37jMIDlXmT7sgGDW
// SIG // nFsciiHKia2TUNQ9wGnsVCq0EISooeKRXIjVWZ7810wB
// SIG // PEkFgC9KTFWk7F5FrGL6YXDVqYvVF8OLMaYlkPqjspLh
// SIG // h4vQG02lekfJAQ0dVkJjogJz5zEcBOiDrlkx5heiQ1BJ
// SIG // JxB0bwHB2B7ebj3mEwXJ3/iFzblVjYncphCbNuGoMcvE
// SIG // VSQDwiq4OcnldxOFVNAbhaFP2icvhXnj7bSYFXtICtXQ
// SIG // PUl3Vax515TAL991K9ys8B33RFUBndOZh2lUfS3U3kRi
// SIG // mxJwpL/UTr8hNIeTcYNZ6ThAUYHD6dVbW0HUGfXdGzhg
