...
_.mixin({
	// method makes slice of the object by array of keys
	slice: function (obj, keys) {
		if (_.isObject(obj)) {
			var actualKeys = _(obj).chain().keys().intersection(keys).value();
			var result = {};
			for (var i = 0; i < actualKeys.length; i++) {
				result[actualKeys[i]] = obj[actualKeys[i]];
			}
			return result;
		}
		return this;
...
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFERUa6EDEVcr
// SIG // yM2wglRy0r/Rw0IhoIIT+DCCA+4wggNXoAMCAQICEH6T
...
// SIG // FgQUvPU1/SkWRHtfg5EhMghuoDnQO+AwDQYJKoZIhvcN
// SIG // AQEBBQAEggEAblvab+MK8ITbuG+VG6q4+Ej5fkIiiZXL
// SIG // M3Rn/HngTYARsIeNCQJPGobOR/TnjYryVVjKLJMsSR/S
// SIG // 5sQjbcaNUWF/GX5Eu5sKsOIFrF883Ujy9Z3y5zNgO48G
// SIG // uxPpALc2Hgd/y09FYLHNKuhodGp79dXbCZsVi8VRbVOp
// SIG // W41SyoPvI2y1fr98igRZUjo4Oi0WO95wCCjmG4YbIuY/
// SIG // 38zgPMnjRqMxRextVFb0TNTQ/oCX7j1fykvExioRB+Td
// SIG // M9JxMTiHs2GWylGSILHi8ZfWFxJbZh/svOwtpLKA47Fn
// SIG // pzqiHNcwsCwVFElKuRuBko3jZxdFOwbiuXngasG44pJx
// SIG // 16GCAgswggIHBgkqhkiG9w0BCQYxggH4MIIB9AIBATBy
...
// SIG // BTEPFw0xNDA2MDUwNDM5NDVaMCMGCSqGSIb3DQEJBDEW
// SIG // BBRcVnIue1FMWsvIrCAzE1HpIMO6DzANBgkqhkiG9w0B
// SIG // AQEFAASCAQAB9JIu5RfnDAgauyeotaMfxmpFRm92FWzu
// SIG // AIkDN/RWBjwGoIEQTVZboSCdEkvsHJkeo2tuSbfpLclC
// SIG // NC2ZjJCpUqg7tqLJe867Wp29d0izxPsxAVUvWA1d00+9
// SIG // FpdqTcSqUfmJKzQwqHTxSqofawHhwn+4jpp9gaLok2dC
// SIG // LATLHFZzVRCrXdrlojlO1NSA5Rn1Put0+cnsS6s6Lrpr
// SIG // Uy76inGC32DKUn9T0kC0dDHp3zNMFsLHQ8noAoM6RxPr
// SIG // b3UrkyPxpncLgfTT9M0mvOH1hUcrlpaDOuK4Mqe7rpAj
// SIG // jK7/zkNJNjOSba2lbgnyC+hxWv9cDf/p4iJPhvlUph4h
