...
The vulnerability of Distributed Hash Tables to Sybil attacks and Eclipse attacks have been well known for some time.
However, these vulnerabilities has often been explored in a theoretical sense, assuming the attacker is an all-knowing  and all-powerful global adversary from the beginning.
...
While mashing can be used for malicous behavior, we describe methods and applications for the technique that are beneficial for performing load balancing.
