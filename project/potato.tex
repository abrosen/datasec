...
Our analysis and experiments show that an adversary with a small number of machines and limiting their port usage to the ephemeral ports can easily compromise a P2P system and occlude the majority of links.
...
Other techniques such as proof-of-work \cite{4215910} may provide a defense against Sybil attacks, 
but proof-of-work systems must set their computational puzzles to be simple enough for the weakest member of the network to participate.
