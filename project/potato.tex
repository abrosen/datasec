...
% assumptions for an adversary to have to perform a Sybil attack.
...
%TODO CHECK REDO WE DON'T MAKE ANY ASSUMPTIONS ABOUT THE WORK NEEDED TO MAKE A CLIENT
...
In Chord, this number is a system configuration value $r$ \cite{chord}.  %TODO DONE
...
Most sets of meaningful keys will not have a uniform distribution. %TODO CITE SHANNON ENTROPY AND INFO PAPER
