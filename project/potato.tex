...
Current research demonstrates  BitTorrent is vulnerable to the Sybil attack and \footnote{Perhaps the only reason that Bittorrent hasn't be attacked in such a way as to render it unuable }.


There have been many suggestions on how to defend against Sybil attack, but there is no agreed upon ``silver bullet'' among researchers that should be 
