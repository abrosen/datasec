...
Our analysis and experiments show that an adversary with a small number of machines and limiting their port usage to 
...
More efficient to lie when you can on Plaxton networks.
