...
%TODO IS JUDGING BY HASH OF IP PORT VALID?
...
%TODO PSUEDOCOLLISIONS
The process for mashing is similar to searching for a collision via a birthday attack, but much easier.
...
%TODO WHY CHORD AND NOT OTHER DHTS LIKE CAN
